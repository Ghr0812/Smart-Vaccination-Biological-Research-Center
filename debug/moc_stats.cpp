...
#include "../Projet_Recherche/stats.h"
...
static constexpr auto qt_meta_stringdata_ZN5StatsE = QtMocHelpers::stringData(
    "Stats",
    "on_b6_clicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5StatsE[] = {
...
Q_CONSTINIT const QMetaObject Stats::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5StatsE.offsetsAndSizes,
    qt_meta_data_ZN5StatsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5StatsE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Stats, std::true_type>,
        // method 'on_b6_clicked'
...
void *Stats::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5StatsE.stringdata0))
