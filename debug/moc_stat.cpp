...
#include "../Projet_Recherche/stat.h"
...
namespace {
struct qt_meta_tag_ZN4statE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN4statE = QtMocHelpers::stringData(
    "stat"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN4statE[] = {
...
Q_CONSTINIT const QMetaObject stat::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4statE.offsetsAndSizes,
    qt_meta_data_ZN4statE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4statE_t,
        // Q_OBJECT / Q_GADGET
...
void *stat::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4statE.stringdata0))
