...
#include "../../../Projet_Recherche/qrcode.h"
...
static constexpr auto qt_meta_stringdata_ZN6QrCodeE = QtMocHelpers::stringData(
    "QrCode"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6QrCodeE[] = {
...
Q_CONSTINIT const QMetaObject QrCode::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6QrCodeE.offsetsAndSizes,
    qt_meta_data_ZN6QrCodeE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6QrCodeE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QrCode, std::true_type>
    >,
    nullptr
} };
...
void *QrCode::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6QrCodeE.stringdata0))
