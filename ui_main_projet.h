...
"        }"));
        ...
        pushButton->setGeometry(QRect(510, 60, 51, 61));
...
"            box-shadow: 4px 4px 8px rgba(0, 0, 0, 0.2);\n"
"            transition: transform 0.2s, box-shadow 0.2s;\n"
"qproperty-icon: url(\"Y:/Smart-Vaccination-Biological-Research-Center/NextGen/resources/refresh.png\"); /* Chemin de l'ic\303\264ne */\n"
"    qproperty-iconSize: 35px 35px; /* Taille de l'ic\303\264ne */\n"
"        }\n"
"        QPushButton:hover {\n"
"            transform: scale(1.05);\n"
"            box-shadow: 6px 6px 12px rgba(0, 0, 0, 0.3);\n"
...
"        }"));
        QIcon icon;
        icon.addFile(QString::fromUtf8("../resources/refresh.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
